...
public:
    ...
    bool sendMarketOrder(const std::string& symbol, char side, double qty,
        ...
        std::string clOrdID = tradeSession_.sendNewOrder(symbolId, side, qty, FIXOrdType::Market, 0.0, positionEffect);
    ...
    bool sendLimitOrder(const std::string& symbol, char side, double qty, double price,
        ...
        std::string clOrdID = tradeSession_.sendNewOrder(symbolId, side, qty, FIXOrdType::Limit, price, positionEffect);
