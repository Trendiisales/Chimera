...
// Suppress spurious GCC warning about strncpy + struct assignment
...
// =============================================================================
// Simple SPSC Ring Queue for Execution Engine (ParentOrder/ChildOrder)
// =============================================================================
...
template<typename T, size_t C = 256>
using LockFreeQueue = ExecQueue<T, C>;
...
private:
    ...
    inline void sendChildOrder(ParentOrder& order, double qty, double price, 
        ...
        child.symbol[15] = '\0';  // Ensure null termination
