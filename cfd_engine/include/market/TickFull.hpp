// =============================================================================
// TickFull.hpp - Unified Tick Structure for CFD Engine
// =============================================================================
// v4.12.0: CRYPTO REMOVED - CFD/cTrader only
//
// SPECIFICATION:
//   - Used by CfdEngine only
...
// Venue identifiers - v4.12.0: Only cTrader remains
enum class Venue : uint8_t {
    UNKNOWN = 0,
    CTRADER = 2    // cTrader CFD/Forex via FIX or OpenAPI
};
...
// =============================================================================
// Size: 192 bytes (3 cache lines, aligned to 64 for atomic access)
// =============================================================================
struct alignas(64) TickFull {
    // =========================================================================
    // IDENTITY (16 bytes)
    // =========================================================================
    char symbol[16];              // Fixed-size symbol (e.g., "XAUUSD", "NAS100")
    ...
    // METADATA (8 bytes)
    // =========================================================================
    Venue venue;                  // 2=cTrader (only venue)
    ...
    TickFull() {
        ...
        venue = Venue::CTRADER;   // Default to cTrader
    }
