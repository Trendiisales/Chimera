...
inline BrokerScore binanceBaseline() {
    BrokerScore s;
    strncpy(s.broker, "BINANCE", 31);
    strncpy(s.symbol, "BTCUSDT", 15);
    s.ack_p50_ms = 0.3;
    s.ack_p80_ms = 0.5;
    s.ack_p95_ms = 1.2;
    s.cancel_p95_ms = 1.5;
    s.reject_rate = 0.02;
    s.maker_fill_rate = 0.15;  // Low without colo
    s.taker_fill_rate = 0.98;
    s.taker_cost_bps = 5.5;
    s.maker_cost_bps = 2.0;
    s.spread_bps = 1.0;
    s.slippage_bps = 0.5;
    return s;
}
