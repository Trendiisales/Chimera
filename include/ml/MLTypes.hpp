...
// =============================================================================
// v4.9.1: Engine ID - Which top-level engine generated the trade
// =============================================================================
enum class EngineId : uint8_t {
    BINANCE = 0,   // Crypto engine (BTCUSDT, ETHUSDT)
    CFD     = 1,   // cTrader FIX engine (Forex, Metals, Indices)
    INCOME  = 2,   // Income engine (NAS100 mean reversion)
    UNKNOWN = 255
};

// =============================================================================
// v4.9.1: Strategy ID - Which specific strategy/profile generated the trade
// =============================================================================
enum class StrategyId : uint8_t {
    // Crypto strategies (1-9)
    CRYPTO_SCALP       = 1,   // Live crypto scalping (legacy)
    CRYPTO_SHADOW      = 2,   // Shadow/paper trades for expectancy
    CRYPTO_MICROSCALP  = 3,   // v4.9.1: Speed-first micro-scalper
...
inline const char* engineToString(EngineId e) {
    switch (e) {
        case EngineId::BINANCE: return "CRYPTO";
...
inline const char* strategyToString(StrategyId s) {
    switch (s) {
        case StrategyId::CRYPTO_SCALP:      return "CryptoScalp";
        case StrategyId::CRYPTO_SHADOW:     return "CryptoShadow";
        case StrategyId::CRYPTO_MICROSCALP: return "MicroScalp";
...
struct alignas(64) MLFeatureRecord {
    ...
    uint8_t  engine_id;             // v4.9.1: Which engine (EngineId)
