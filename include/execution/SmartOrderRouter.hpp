...
// ═══════════════════════════════════════════════════════════════════════════════
// v4.9.11: MULTI-VENUE SMART ORDER ROUTING (SOR)
//
...
//
// SUPPORTS:
// - BlackBull / Pepperstone / IC Markets (CFD)
...
inline VenueScore binance() {
    VenueScore v;
    strncpy(v.venue, "BINANCE", 31);
    v.latency_ms = 0.5;
    v.fill_rate = 0.95;
    v.spread_bps = 1.0;
    v.reject_rate = 0.02;
    v.commission_bps = 5.0;
    return v;
}
