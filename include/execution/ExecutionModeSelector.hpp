...
// ═══════════════════════════════════════════════════════════════════════════════
// v4.11.0: INSTITUTIONAL EXECUTION MODE SELECTION (CFD only)
//
...
// v4.11.0: crypto options removed
// ─────────────────────────────────────────────────────────────────────────────
...
// ─────────────────────────────────────────────────────────────────────────────
// v4.11.0: Simplified - no crypto parameter
inline ExecModeResult chooseExecMode(
    double recent_fill_rate,
    double reject_rate,
    double ack_p95_ms,
    ...
    cap.allow_maker = ack_p95_ms < 5.0;  // v4.11.0: no crypto check
    cap.confidence = 0.5;
