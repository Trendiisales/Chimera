...
// ═══════════════════════════════════════════════════════════════════════════════
// v4.9.27: SINGLE-OWNER PROBE CONTROLLER
//
...
//   probe_ctrl.onTick("BTCUSDT", mid_price);
// ═══════════════════════════════════════════════════════════════════════════════
#pragma once
...
public:
    ...
    static constexpr double PROBE_QTY = 0.0001;                        // Minimal safe qty (BTC)
    ...
    // ═══════════════════════════════════════════════════════════════════════
    // CALLBACKS - Wire these from BinanceEngine
    // ═══════════════════════════════════════════════════════════════════════
