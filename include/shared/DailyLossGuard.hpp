...
public:
    // v4.5.1: Hard daily loss limit: -$200 NZD (was -$500)
    // This is NON-NEGOTIABLE. Nothing overrides it.
    static constexpr double DEFAULT_LIMIT_NZD = -200.0;
    ...
    // Used by UnifiedRiskScaler to decay position size before hitting limit
    ...
    // exp = 2.0 means aggressive slowdown as DD approaches limit
