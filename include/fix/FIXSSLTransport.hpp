...
// =============================================================================
// v3.4: PRODUCTION BUILD - All debug output disabled for stability
// =============================================================================
...
// =============================================================================
// DEBUG LOGGING MACROS - v4.6.0: ENABLED for diagnostics
// =============================================================================
#define FIX_DEBUG(msg) std::cout << "[FIX-DBG] " << msg << "\n"
#define FIX_DEBUG_FMT(fmt, ...) do { char _buf[512]; snprintf(_buf, sizeof(_buf), fmt, ##__VA_ARGS__); std::cout << "[FIX-DBG] " << _buf << "\n"; } while(0)
...
private:
    ...
    bool sslHandshake() {
        ...
        if (ret != 1) {
            ...
            (void)err;  // Used in debug macro below
            char errbuf[256];
    ...
    void rxLoop() {
        ...
        try {
            ...
            while (running_.load()) {
                ...
                if (n > 0) {
                    // v3.4: Debug output REMOVED - was causing memory pressure crashes
