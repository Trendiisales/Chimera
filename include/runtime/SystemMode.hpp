...
struct SymbolBootstrapState {
    ...
    // v4.9.27: ACK-GATING - Critical fix for Binance WS stability
...
inline ProbeConfig getProbeConfig(const char* symbol) {
    // v4.9.27: INCREASED SPACING to avoid Binance rate limits
    // Binance WS API: 1200 requests/10min = 2/sec max
    ...
    // CRYPTO - High latency variance, need more probes
