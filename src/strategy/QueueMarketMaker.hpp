...
private:
    ...
    static constexpr double MAX_POS = 0.30;    // Discovery mode
    static constexpr double BASE_QTY = 0.005;  // Small size for quasi-passive
    static constexpr double EDGE_BPS = 0.12;   // Discovery mode: 0.08-0.12 bps (was 5.0)
    static constexpr double INV_K = 0.35;      // Inventory aversion (was 0.25)
